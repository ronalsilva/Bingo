...
Class Conexao {
	...
	function open(){
		...
		// $open = @pg_connect("user=postgres, dbname=bingo, host=localhost, password=ronaldjunger") or die("Impossível abrir conexão");
		// $this->con = pg_exec($open) or die("Impossível executar consulta");
